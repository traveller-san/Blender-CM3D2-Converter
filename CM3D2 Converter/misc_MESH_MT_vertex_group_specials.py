...
class quick_transfer_vertex_group(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if self.is_clean:
            bpy.ops.object.vertex_group_clean(group_select_mode='ALL', limit=0.00000000001)
...
class blur_vertex_group(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for vert in me.vertices:
            new_vert_datum = []
            near_vert_data.append(new_vert_datum)
            near_vert_data_append = new_vert_datum.append
